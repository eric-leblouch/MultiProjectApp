...
SwaggerOperation.prototype.getSignature = function(type, models) {
  ...
  if (isPrimitive) {
    ...
    if (listType != null) {
      // Ubeeko -- Fix signature not showing array nature
      // (see <https://github.com/zircote/swagger-php/issues/152>)
      //return models[listType].getMockSignature();
      return '<span class="strong">[&nbsp;</span>'+models[listType].getMockSignature()+'&nbsp;<span class="strong">]</span>';
    } else {
